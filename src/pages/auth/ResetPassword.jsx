    ...
    return (
        <>
            <div className="relative w-[43%] min-w-[465px] max-w-[465px] mr-12">
                <img src="https://i.imgur.com/TajTTX6.png" alt="" className="h-[550px] radius-secondary object-cover" />
            ...
            <div className="auth-content flex flex-col justify-center w-[350px]">
                <h2 className="my-[1px] text-3xl font-bold">Enter your new password</h2>
                ...
                <form action="" className="mt-[20px] mb-[10px]" id="signUp">
                    ...
                    <div className="form__item text-right">
                        <button type="submit" className="auth__button border-none radius-primary bg-primary-color px-[10px] py-[10px] text-white trans-second block w-full mt-1 hover:opacity-90">Save</button>
                    </div>
                </form>
            </div>
        </>
