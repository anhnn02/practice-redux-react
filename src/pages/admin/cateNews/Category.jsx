...
// import { create, list, remove } from '../../../api/categoryNews'
...
//                                                     className=""
//                                                     aria-label="Edit">
//                                                     <Link to={`/admin/category-news/${item._id}/edit`} className="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg :text-gray-400 focus:outline-none focus:shadow-outline-purple">
